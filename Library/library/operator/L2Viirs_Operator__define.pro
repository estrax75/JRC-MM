...
FUNCTION L2Viirs_Operator::doParCodeCorrection, parCodes
  ...
  if count ge 1 then parTest[parCheckIdx]='RRS_410'
  parCheckIdx=where(parTest eq 'RRS_670', count)
  if count ge 1 then parTest[parCheckIdx]='RRS_671'
