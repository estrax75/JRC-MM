...
function buildMODISFAPARFileName_TC, sensor, resolution, year, month, day, mission, missionCode, mainVar, startDay=startDay, endDay=endDay;MONTHLY=MONTHLY, TENDAYS=TENDAYS
  ...
  fName='MOD01_TER01_'+yearS+monthS+DAYS+'000000_'+yearS+monthS+DAYS+$
