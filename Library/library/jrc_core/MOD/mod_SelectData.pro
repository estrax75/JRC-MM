...
PRO mod_SelectData,filename,SatStruct,line,elem,subsetsize,SatData,option
...
; AOT_412
             name = "taua_412"
             subset=fltarr(n_square) & subset(*)=hbad
             mod_ExtractSubset,filename,name,vlist,n_side,line,elem,subset,header,iflag
