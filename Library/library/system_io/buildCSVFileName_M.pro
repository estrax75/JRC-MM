function buildCsvVarFileName_M, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, $
  ...
  periodName='12months'
  fileName=string(format='(A, "_", A, "_", A, "_", A, ".csv")', prefix, periodName, parameter, roi)
