;launch_FAPAR_AVHRR_Howmuller_year, 1987, 1987, 12, 'NC'
pro launch_FAPAR_AVHRR_Howmuller_year, startyear, endyear, mission, $
  ...
  for year=startyear, endyear do begin
    ...
    do_FAPAR_AVHRR_Howmuller_Year, year, title1, title2, selPar, inputDir, outputDir, missionIndex, $
