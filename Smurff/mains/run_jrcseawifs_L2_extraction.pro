PRO run_jrcseawifs_L2_extraction, request, NODISPLAY=NODISPLAY
  ...
  sensorName='JRCSEAWIFS'
  siteNo=n_elements(siteInfoStruct)
  L2Op=obj_new('L2JRCSeaWiFS_Operator', mainApp, tempDir, periodType)
  ...
  for i=0, siteNo-1 do begin
    ...
    jrcswf_ExtractData, option, inputDirs[0], outputDir[0], inputFileFilter, correctedVarList, siteInfoStruct[i], L2Op, periodType, yearList, sensorName, $
