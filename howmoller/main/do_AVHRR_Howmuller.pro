pro do_AVHRR_Howmuller, month, year, sourceParameter, parameter, $
  ...
  parListToRead=['SREFL_CH1','SREFL_CH1','QA']
  parListToWrite=['SREFL_CH1','SREFL_CH1']
  sensor='AVH09C1'
  missionCode='N'
  ...
  for timecount=0, timelapse-1 DO BEGIN
    ...
    if  count eq 1 then begin
      ...
      for lon=0, 3600-1 DO BEGIN
        ...
        ;
        idxlon1=where(bug1 ge 0.)
        idxlon2=where(bug2 ge 0.)
