...
function buildGlobModisAParFileName_M, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, $
  ...
  glob_patt = string(format='("A", I4, I03, '+mediumFilter+')', year, sjday)
