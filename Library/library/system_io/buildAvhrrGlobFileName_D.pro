...
;GLOBAL_L3_GEOG_0.05DEG_001-001_03.NOAA-16.hdf
function buildAvhrrGlobFileName_D, sensor, missionCode, year, month, day, archivedir, FULLPATH=FULLPATH, $
  ...
  if keyword_set(JULDAY) then fileName=string(format='(A, "_", I03, "-", I03, "_", A, ".", A,"_*", A)', sensor, day, day, twoDigityear, missionCode, fileType) else $
    fileName=string(format='(A, "_", I02, I02, "-", I02, I02, "_", A, ".", A,"_*", A)', sensor, day, month, day, month, twoDigityear, missionCode, fileType)
