pro ncdfread, filename,variable_name, data_variable, slope, intercept, dims
...
NCDF_ATTGET, fileID, Varid, 'slope', slope
NCDF_ATTGET, fileID, Varid, 'intercept', intercept
