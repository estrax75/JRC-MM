...
function buildGlobVIIRSParFileName_D, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, $
  ...
  glob_dir = archiveRoot + pathSep + year_str + path_sep + 'DAILY'
