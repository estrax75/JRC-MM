FUNCTION readDaacPar, buildFileNameFunction, periodType, getVarDataFunction, $
  ...
  ;outBandNames=mainApp->getKeyValue('DAAC_BAND_NAMES')
  parInfo=mainApp->getParameterByCode('daacPar') 
  ...
  mosaicFileName=tempDir+path_sep()+'euro_daac_'+strtrim(year)+'_'+strtrim(month)+'.envi'
