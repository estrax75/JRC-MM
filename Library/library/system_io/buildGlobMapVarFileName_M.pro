function buildGlobMapVarFileName_M, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, $
  ...
  fileName=string(format='(A, "_", A, "_", I4, "_", I02,"_",A,".nc")', prefix, parameter, year, date, roi)
