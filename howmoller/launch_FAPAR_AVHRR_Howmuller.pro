;launch_FAPAR_AVHRR_Howmuller, 1981, 1981, 1, 12, 'NC'
pro launch_FAPAR_AVHRR_Howmuller, startyear, endyear, startmonth, endmonth, sourceformatType, missionIndex, $
  ...
  for year=startyear, endyear do begin
    for month=startmonth, endmonth do begin
      ...
      do_FAPAR_AVHRR_Howmuller, month, year, title1, title2, sourceformatType, inputBaseDir, outputDir, missionIndex, $
