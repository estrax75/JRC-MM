pro edit_georef_ncdf, sfileName, dfileName, nbandNames, nbandunits
  ; procedure to read a geoTiff and export an a new one

  if ~obj_valid(fsObj) then fsObj=obj_new('FileSystem', /STAND)
  fileName1=fsObj->getFileNameInfo(sfileName, filePath=filePath1, extension=extension1)
  fileName1=fsObj->getFileNameInfo(dfileName, filePath=filePath2, extension=extension2)
  ...
  ncid1 = NCDF_OPEN(tempFileName1,/NOWRITE)
  ncid2 = NCDF_CREATE(tempFileName2,/CLOBBER)
