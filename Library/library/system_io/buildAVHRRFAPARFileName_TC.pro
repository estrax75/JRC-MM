...
function buildAVHRRFAPARFileName_TC, sensor, resolution, year, month, day, mission, missionCode, mainVar, startDay=startDay, endDay=endDay;MONTHLY=MONTHLY, TENDAYS=TENDAYS
