;do_BRF_AVHRR_Howmuller, 1, 1999, 14, 'BRFs', 'band1_2','NC', '/space3/storage/products/results/BRFs/HM', eps=EPS, TC_TYPE=TC_TYPE
;do_BRF_AVHRR_Howmuller, 2, 2003, 16, 'BRFs', 'band1_2','NC', '/space3/storage/products/results/BRFs/HM', eps=EPS, TC_TYPE=TC_TYPE
pro do_BRF_AVHRR_Howmuller_, month, year, NOAANUMBER, sourceParameter, parameter, formatType, outDir, eps=EPS, TC_TYPE=TC_TYPE
  ;
  ; QA4EVC daily BRFs
  ;
  ...
  for timecount=0, timelapse-1 DO BEGIN
    ...
    if  count eq 1 then begin
      ...
      if formatType eq 'NC' then begin
      ...
      if formatType eq 'HDF' then begin
        operatorObj->readHdfFullInfoData, res_ldtr, 'BRF_BAND_1', avhrr_b1, slope_b1, intercept_b1, b1_fillvalue, ERROR=ERROR, /APPLY
        operatorObj->readHdfFullInfoData, res_ldtr, 'BRF_BAND_2', avhrr_b2, slope_b2, intercept_b2, b2_fillvalue, ERROR=ERROR, /APPLY
        operatorObj->readHdfFullInfoData, res_ldtr, 'SIGMA_BRF_BAND_1', sigma_b1, slope_sb1, intercept_sb1, sigma1_fillvalue, ERROR=ERROR
        operatorObj->readHdfFullInfoData, res_ldtr, 'SIGMA_BRF_BAND_2', sigma_b2, slope_sb2, intercept_sb2, sigma1_fillvalue, ERROR=ERROR
      endif
