PRO run_scatter_biomap_v1_M, request, NODISPLAY=NODISPLAY
  ...
  if periodType ne 'M' then message, 'This run is designed for working with monthly (biomap v1) data, you need to (copy and) custom it if you want a different interval period and/or data'
