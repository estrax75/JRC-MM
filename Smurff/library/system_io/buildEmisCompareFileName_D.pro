function buildEmisCompareFileName_D, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, $
...
;function buildEmisBioMapVarFileName_D, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, JULDAY=JULDAY, INTERVAL=INTERVAL, TEMPDIR=TEMPDIR, NOTFOUND=NOTFOUND
;
;  prefix="EMIS" ;"BIOMP_"
;
