PRO run_split_plot_report_time_series_abs_mr_D, request, NODISPLAY=NODISPLAY
...
monthlyData=computeMonthlyStatFromDaily(operator, roiNo, singleStatToApply, destinationPeriodtype, parName,  numInPar, yearList, monthList, statTimeSeriesData, reportTimeSeriesData, timeSeriesData, $
