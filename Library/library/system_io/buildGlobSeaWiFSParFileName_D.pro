...
function buildGlobSeaWiFSParFileName_D, year, date, periodType, roi, sensor, parameter, archivedir, FULLPATH=FULLPATH, $
  ...
  glob_dir = archiveRoot + pathSep + 'DAILY' + pathSep + year_str  
  
  mediumFilter="""*.L3m_DAY_"
  ...
  glob_patt = string(format='("S", I4, I03, '+mediumFilter+')', year, date)
