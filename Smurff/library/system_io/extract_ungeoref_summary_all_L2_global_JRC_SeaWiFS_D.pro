FUNCTION extract_ungeoref_summary_all_L2_global_JRC_SeaWiFS_D, periodType, $
  ...
  extraDataInfo=extraDataInfo, RESET=RESET
  ...
  L2Op=obj_new('L2JRCSeawifs_Summary_Operator', mainApp, tempDir, sensorCode='JRCSeawifs')
  
  data=L2Op->importBand(periodType, parCode, date, year, roiCode, roiArchiveCode, inputDir, NF=NF, $
    day=day, targetMapInfo=targetMapInfo, report=report, DUPLICATE=DUPLICATE, extraDataInfo=extraDataInfo, /ALL_DATA, RESET=RESET)
