PRO run_viirs_L2_extraction, request, NODISPLAY=NODISPLAY
  ...
  L2Op=obj_new('L2Viirs_Operator', mainApp, tempDir, periodType)
  ...
  for i=0, siteNo-1 do begin
    ...
    vrs_ExtractData, option, inputDirs[0], outputDir[0], inputFileFilter, correctedVarList, siteInfoStruct[i], L2Op, periodType, sensorName, $
