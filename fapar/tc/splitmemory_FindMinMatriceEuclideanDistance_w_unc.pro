Pro sm_call_mean_3_unc,  daysNumber, data_in, mean_field, std_mean, std_field, nfield, flagNan, splitDims
  ;
  ...
  if nfield eq 3 then begin
    for t=0, tt(1)-1 do begin
      ...
      buff(*,*)=mean_field(*,*).red
      idx=where((buf gt 0. and buf lt 1.0) and (buff gt 0. and buff lt 1.) and data_in(t).flag eq 0. and num_used ge 3.0) ;ng 2016
      ...
      idx=where((buf gt 0. and buf le 1.0) and (buff gt 0. and buff le 1.) and (data_in(t).flag eq 0.) and num_used ge 3.0) ;ng 2016
      if idx(0) ge 0 then begin
        ; Here apply a weight factor based on sigma...
    ...
    for t=0, tt(1)-1 do begin
      ...
      ;buff(*,*)=mean_field(0,*,*)
      buff(*,*)=mean_field(*,*).red
      idx=where((buf gt 0. and buf lt 1.0) and (buff gt 0. and buff lt 1.) and (data_in(t).flag eq 4. or data_in(t).flag eq 5.) and num_used ge 3.0) ; ng 2016
...
PRO sm_FindEuclideanMatricDistance_unc, daysNumber, data_in, idx_third, distance, mean_field, std_mean, nfield, flagNan, splitDims
  ;
  ;
  ;
  ; inputs:
  ...
  ;
  ;
  sm_call_mean_3_unc, daysNumber, data_in, mean_field, std_mean, std_field, nfield, flagNan, splitDims
  ;
