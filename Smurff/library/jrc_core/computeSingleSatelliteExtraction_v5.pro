PRO computeSingleSatelliteExtraction_v5
    ...
    for j=0, n_elements(siteList)-1 do begin
      ...
      for k=0, count-1 do begin
        ...
        for m=0, parNo-1 do begin
          parFiles[m]=sourceDirPrefix+sensorList[i]+sourceDirPostfix+prefix+parList[m]+postfix
...
;        store-->mwind           6        1999
        ...
        matchUPStruct=computeMatchUp_v5(flagData, flagToBit, $
        ...
        destSat[index].statValues=matchUPStruct.statValues
