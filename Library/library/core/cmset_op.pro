...
function cmset_op, a, op0, b, not1=not1, not2=not2, count=count, $
              empty1=empty1, empty2=empty2, maxarray=ma, index=index, NULL=NULL
  ...
  if n1 EQ 0 OR n2 EQ 0 then begin
     ...
     count = n1
     if kind then begin
         if count GT 0 then return, a1 else goto, ret_null  ;return, -1L
     endif
     if count GT 0 then return, a(a1) else goto, ret_null  ;return, -1L
     RET_B1:
     count = n2
     if kind then begin
         if count GT 0 then return, b1+n1 else goto, ret_null  ;return, -1L
     endif         
     if count GT 0 then return, b(b1) else goto, ret_null  ;return, -1L
 endif
  ...
  if tp1 GE 4 AND tp1 LE 9 then begin
      ...
      case op of 
          ...
          'XOR': begin
              ...
              if count1 EQ 0 then goto, ret_null  ;return, -1L
          ...
          'AND': begin
              ...
              if NOT keyword_set(not1) AND NOT keyword_set(not2) then begin
                  ...
                  if count EQ 0 then goto, ret_null  ;return, -1L
      ...
      endcase
      goto, ret_null ;return, -1L  ;; DEFAULT CASE
  endif else begin
