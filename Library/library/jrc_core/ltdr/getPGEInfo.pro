function getPGEInfo, dir, file, globDim=globDim, FORCEREAD=FORCEREAD
  ...
  ST_operator->readHdfFullInfoData, ff1, datasetname, slope_v1, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff1, datasetname, intercept_v0, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff1, datasetname, slope_r1, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff1, datasetname, intercept_r1, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff1, datasetname, NDVImin, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff1, datasetname, NDVImax, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff2, datasetname, slope_v1, slope, offset, fillvalue, info=INFO
  ...
  ST_operator->readHdfFullInfoData, ff2, datasetname, intercept_v1, slope, offset, fillvalue, info=INFO
  BRDF_params1[1].intercept_v1=reform(intercept_v1, globDim)
  intercept_v1=0

  datasetname='slope_band02_parameter_R1'
  ;read_data, dir, file2, datasetname, slope_r1, slope, offset, fillvalue, info=INFO
  ST_operator->readHdfFullInfoData, ff2, datasetname, slope_r1, slope, offset, fillvalue, info=INFO
  BRDF_params1[1].slope_r1=reform(slope_r1, globDim)
  slope_r1=0
  datasetname='intercept_band02_parameter_R0'
  ;read_data, dir, file2, datasetname, intercept_r1, slope, offset, fillvalue, info=INFO
  ST_operator->readHdfFullInfoData, ff2, datasetname, intercept_r1, slope, offset, fillvalue, info=INFO
  BRDF_params1[1].intercept_r1=reform(intercept_r1, globDim)
  intercept_r1=0

  datasetname='ndvi min'
  ;read_data, dir, file2, datasetname, slope_r1, slope, offset, fillvalue, info=INFO
  ST_operator->readHdfFullInfoData, ff2, datasetname, NDVImin, slope, offset, fillvalue, info=INFO
  BRDF_params1[1].NDVImin=reform(NDVImin, globDim)
  NDVImin=0

  datasetname='ndvi max'
  ;read_data, dir, file2, datasetname, intercept_r1, slope, offset, fillvalue, info=INFO
  ST_operator->readHdfFullInfoData, ff2, datasetname, NDVImax, slope, offset, fillvalue, info=INFO
