...
function buildSWFFAPARFileName_D, sensor, resolution, year, month, day, mission, missionCode, mainVar, level, startDay=startDay, endDay=endDay;MONTHLY=MONTHLY, TENDAYS=TENDAYS
  ...
  fName=prefix+'_'+orbit+'_'+yearS+monthS+startDayS+fakeTimeStamp+'_'+yearS+monthS+endDayS+$
    fakeTimeStamp+'_'+thislevel+'_'+par+'_'+versionCoding+'_'+earthLocation+'_'+prjType+'_'+boh2+'_'+boh3
