PRO run_split_plot_summary_analysis_v2_mr_d, request, NODISPLAY=NODISPLAY
...
monthlyData=computeMonthlySummaryFlagStatsFromDaily_V2(operator, roiNo, resSingleStatToApply, destinationPeriodtype, $
