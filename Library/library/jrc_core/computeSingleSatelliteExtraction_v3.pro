PRO computeSingleSatelliteExtraction_v3
  ...
  for i=0, n_elements(sensorList)-1 do begin
    ...
    for j=0, n_elements(siteList)-1 do begin
      ...
      for k=0, count-1 do begin
        ...
        matchUPStruct=computeMatchUp_v3(flagToBit, angData, aotData, chlaData, rrs443Data,rrs490Data, rrs555Data,flagData)
        ...
        destSat[index].statDesc=matchUPStruct.nonFlaggedCount
