FUNCTION do_single_neural_net_v2_D_to_M, periodType, $
  ...
  neuralNetWaveLengths=mainApp->getKeyValue('NEURAL_NET_V2_USED_WAVELENGTHS')
  ...
  for day=firstDay, lastDay do begin
    ...
    neuralNetOp=obj_new('NeuralNetOperatorV2', mainApp, tempDir, periodType, biomapWaveLengths, confFile=neuralNetConfFile, /ENVITYPE, fileName=dataFile, bandToExportList=bandToExportList, /COPY)
