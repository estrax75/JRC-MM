...
FUNCTION L2Seawifs_Summary_Operator::getInternalOperator, mainApp, tempDir, sensorCode

  return, obj_new('L2Seawifs_Operator', mainApp, tempDir, sensorCode=sensorCode)

END

PRO L2Seawifs_Summary_Operator::CleanUp

  self->L2Summary_Operator::Cleanup
  
END

FUNCTION L2Seawifs_Summary_Operator::init, application, workingDir, periodType, mask=mask, geoData=geoData, fileName=fileName, bandToExportList=bandToExportList, $
  ...
  self.sensorCode='Seawifs'
  return, 1
  
END

PRO L2Seawifs_Summary_Operator__Define

  Struct = { L2Seawifs_Summary_Operator , $
