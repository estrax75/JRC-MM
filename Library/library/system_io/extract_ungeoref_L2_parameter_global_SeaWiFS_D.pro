FUNCTION extract_ungeoref_L2_parameter_global_SeaWiFS_D, periodType, $
  ...
  L2Op=obj_new('L2SeaWiFS_Operator', mainApp, tempDir, sensorCode='Seawifs')
  
  data=L2Op->importBand(periodType, parCode, date, year, roiCode, roiArchiveCode, inputDir, NF=NF, $
    day=day, targetMapInfo=targetMapInfo, report=report)
  return, data
