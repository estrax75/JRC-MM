function AVH01_merge_BRFGlob, file1, file2, file3, confDir, year, month, day, noaaCode, operatorObj, fsObj, tempDir, testFile=testFile, overwrite=overwrite
  ...
  filePath=tempDir
  resFile=filePath+path_sep()+fName+'.nc'
