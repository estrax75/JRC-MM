; Main call
FUNCTION MultiBandOperator::buildOperatorResultFileName, dType, resultBandName, month, year, sensor, roi, archivedir, JULDAY=JULDAY, INTERVAL=INTERVAL, FULLPATH=FULLPATH
  ...
  return, call_function('buildMultiBandFileName'+'_'+dType, $
...
PRO MultiBandOperator::CleanUp

  self-> TimeSeriesOperator::Cleanup
  
END

FUNCTION MultiBandOperator::init, application, workingDir, periodType, resultBandName, $
...
PRO MultiBandOperator__Define

  Struct = { MultiBandOperator , $
