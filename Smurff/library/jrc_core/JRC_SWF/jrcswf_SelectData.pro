...
PRO jrcswf_SelectData,filename,SatStruct,line,elem,subsetsize,SatData,option
  ...
  name = "taua_412"
  subset=fltarr(n_square) & subset(*)=hbad
  jrcswf_ExtractSubset,filename,name,vlist,n_side,line,elem,subset,header,iflag
