PRO run_seawifs_L2_extraction, request, NODISPLAY=NODISPLAY
  ...
  L2Op=obj_new('L2SeaWiFS_Operator', mainApp, tempDir, periodType)
  ...
  for i=0, siteNo-1 do begin
    ...
    swf_ExtractData, option, inputDirs[0], outputDir[0], inputFileFilter, correctedVarList, siteInfoStruct[i], L2Op, periodType, yearList, sensorName, $
