...
PRO Rectified,sensor,ttasun,ttaview,phisun,phiview,$
  ...
  CASE sensor OF
    'SEA' : BEGIN
      ...
      message, 'SeaWiFS: Check and fill with right coefficients'
      ;
      ; for vegetated
    ...
    'MER' : BEGIN
      ...
      message, 'Meris: Check and fill with right coefficients'
      ;
      ; 2011 VERSION
      ;
      ; vegetated
    ...
    'MOD' : BEGIN
      ...
      message, 'Modis: Check and fill with right coefficients'
      ; vegetated
      ;Modis
    ...
    'OLCI' : BEGIN
      ...
      message, 'Olci: Check and fill with right coefficients'
      ;
      ; vegetated
      ;print,'Coefficients for OLCI '
      ;OLCI
    ...
    'AVHRR16' : BEGIN
      ...
      ;
      ; MM 20160506 new values (table 8, pag. 28)
    ...
    'AVHRR14' : BEGIN
      ...
      message, 'AVHRR14: Check and fill with right coefficients'
      ;
      ; only veg
