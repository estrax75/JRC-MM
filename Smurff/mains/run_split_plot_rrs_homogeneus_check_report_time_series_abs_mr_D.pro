PRO run_split_plot_rrs_homogeneus_check_report_time_series_abs_mr_D, request, NODISPLAY=NODISPLAY
            ...
            if outPercentage gt compareValidityThreshold then begin
              ...
              for l=0, numInPar-1 do begin
                if ptr_valid(bands[l]) then begin
                  ...
                  statTimeSeriesData[k, l, totalDayCount]=extraStatRes2.statValue
  ...
  monthlyData=computeMonthlyComplexCheckStatFromDaily(operator, roiNo, singleStatToApply, destinationPeriodtype, varList, labelList, varList[parIndex], parName, yearList, monthList, statTimeSeriesData, reportTimeSeriesData, timeSeriesData, $
