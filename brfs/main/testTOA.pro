;testTOA, 2000, 1988, 1988, 11, 11, 09, 11
;testTOA, 2000, 1988, 1989, 11, 11, 11, 11
pro testTOA, latPixelValue, year1, year2, month1, month2, noaa1, noaa2, RESET=RESET;, sourceFile, confDir, year, month, day, sensor, missionCode, noaaCode, resolution, mainVar, outputBaseDir, tempDir, $
  ...
  workDir='E:\mariomi\Documents\projects\ldtr\data\result\comparison\test\'
  workDir=ST_fileSystem->adjustDirSep(workDir, /ADD)

  ; all available days of November 1988
  alltoaFilesL1=file_search(workDir+'patmosx_v05r03_NOAA-'+string(noaa1, format='(I02)')+'_asc_d'+string(year1, format='(I4)')+string(month1, format='(I02)')+'*.*')
  alltoaFilesL2=file_search(workDir+'patmosx_v05r03_NOAA-'+string(noaa2, format='(I02)')+'_asc_d'+string(year2, format='(I4)')+string(month2, format='(I02)')+'*.*')

  alltoc1FilesL1=file_search(workDir+'AVHRR-Land_v004_AVH09C1_NOAA-'+string(noaa1, format='(I02)')+'_'+string(year1, format='(I4)')+string(month1, format='(I02)')+'*.*')
  alltoc1FilesL2=file_search(workDir+'AVHRR-Land_v004_AVH09C1_NOAA-'+string(noaa2, format='(I02)')+'_'+string(year2, format='(I4)')+string(month2, format='(I02)')+'*.*')

  allbrfFilesL1=file_search(workDir+'AVH_'+string(year1, format='(I4)')+string(month1, format='(I02)')+'*N'+string(noaa1, format='(I02)')+'.NC')
  allbrfFilesL2=file_search(workDir+'AVH_'+string(year2, format='(I4)')+string(month2, format='(I02)')+'*N'+string(noaa2, format='(I02)')+'.NC')

  ;  alltoaFilesL1=file_search(workDir+'patmosx_v05r03_NOAA-L1'+'*.nc')
  ;  alltoaFilesL2=file_search(workDir+'patmosx_v05r03_NOAA-L2'+'*.nc')
  ;
  ;  alltocFilesL1=file_search(workDir+'AVHRR-Land_v004_AVHL1C1_NOAA-L1'+'*.nc')
  ;  alltocFilesL2=file_search(workDir+'AVHRR-Land_v004_AVHL1C1_NOAA-L2'+'*.nc')

  ;  toaNamesL1=['patmosx_v05r03_NOAA-L1_asc_d1988L204_c20140308.nc', 'patmosx_v05r03_NOAA-L1_asc_d1988L205_c20140310.nc', $
  ;    'patmosx_v05r03_NOAA-L1_asc_d1988L206_c20140313.nc']
  ;  toaNamesL2=['patmosx_v05r03_NOAA-L2_asc_d1988L227_c20140316.nc', 'patmosx_v05r03_NOAA-L2_asc_d1988L228_c20140317.nc', $
  ;    'patmosx_v05r03_NOAA-L2_asc_d1988L229_c20140319.nc']
  ;  toc1NamesL1=['AVHRR-Land_v004_AVHL1C1_NOAA-L1_1988L204_c20130829101307.nc', 'AVHRR-Land_v004_AVHL1C1_NOAA-L1_1988L205_c20130829173924.nc',$
  ;    'AVHRR-Land_v004_AVHL1C1_NOAA-L1_1988L206_c20130829191002.nc']
  ;  toc1NamesL2=['AVHRR-Land_v004_AVHL1C1_NOAA-L2_1988L226_c2013L10L244355.nc', $
  ;    'AVHRR-Land_v004_AVHL1C1_NOAA-L2_1988L227_c2013L10L260039.nc', 'AVHRR-Land_v004_AVHL1C1_NOAA-L2_1988L228_c2013L10L271021.nc']
  ;  ;toc2Names='AVHL1C1.A1988321.NL2.004.2013244212203.hdf'
  ;  brfNamesL1=['AVH_1988L204_001D_900S900N1800W1800E_0005D_BRDF_NL1.NC','AVH_1988L205_001D_900S900N1800W1800E_0005D_BRDF_NL1.NC',$
  ;    'AVH_1988L206_001D_900S900N1800W1800E_0005D_BRDF_NL1.NC']
  ;  brfNamesL2=['AVH_1988L226_001D_900S900N1800W1800E_0005D_BRDF_NL2.NC', $
  ;    'AVH_1988L227_001D_900S900N1800W1800E_0005D_BRDF_NL2.NC', 'AVH_1988L228_001D_900S900N1800W1800E_0005D_BRDF_NL2.NC']
  ext='.nc'
  ;labelsL1=string([indgen(6)+1, indgen(7)+9, indgen(14)+17], format='(I02)')
  ;labelsL1='NL2-1988L2'+labelsL1

  ;labelsL2=string([indgen(7)+9, indgen(14)+17], format='(I02)')
  ;labelsL2='NL2-1989L2'+labelsL2
  ;labelsL2=['NL2-1988L226', 'NL2-1988L227', 'NL2-1988L228']
