FUNCTION readERegionalSatRois_D, buildFileNameFunction, periodType, getVarDataFunction, $
  ...
  for i=0, nroi-1 do begin
    ...
    for day=firstDay, lastDay do begin
      ...
      ;bioMapOp=obj_new('ERegionalOperator', mainApp, tempDir, confFile=biomapConfFile, /ENVITYPE, fileName=rawData.enviDataFile, bandToExportList=bandToExportList)
