PRO run_split_plot_summary_analysis_v5_mr_d, request, NODISPLAY=NODISPLAY
            ...
            for k=0, roiNo-1 do begin
              ...
              if ~keyword_set(NOTFOUND) then begin
                ...
                for l=0, numInPar-1 do begin
                  ...
                  ;parameters between 19 and 22 are directly matchups count
                  if indexToExtract gt 18 and indexToExtract le 22 then band=multipleBand[indexToExtract] else band=1-multipleBand[indexToExtract]
