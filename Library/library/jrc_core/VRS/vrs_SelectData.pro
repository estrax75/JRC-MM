...
PRO vrs_SelectData,filename,SatStruct,FStruct,latitude,longitude,line,elem,subsetsize,SatData,option
...
; PAR
             ...
             name = "par"
             subset=fltarr(n_square) & subset(*)=hbad
             vrs_ExtractSubset,filename,FStruct,name,n_side,line,elem,subset,header,iflag
