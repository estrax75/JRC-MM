PRO run_meris_L2_extraction, request, NODISPLAY=NODISPLAY
  ...
  L2Op=obj_new('L2Meris_Operator', mainApp, tempDir, periodType)
  ...
  for i=0, siteNo-1 do begin
    ...
    mer_ExtractData, option, inputDirs[0], outputDir[0], inputFileFilter, correctedVarList, siteInfoStruct[i], L2Op, periodType, sensorName, $
